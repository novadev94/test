...
func bindCompoundLens(address common.Address, caller bind.ContractCaller, transactor bind.ContractTransactor, filterer bind.ContractFilterer) (*bind.BoundContract, error) {
	parsed, err := abi.JSON(strings.NewReader(CompoundLensABI))
	if err != nil {
		return nil, err
	}
...
func (_CompoundLens *CompoundLensCaller) GetCompBalanceMetadata(opts *bind.CallOpts, comp common.Address, account common.Address) (CompoundLensCompBalanceMetadata, error) {
	var (
		ret0 = new(CompoundLensCompBalanceMetadata)
	)
	out := ret0
...
func (_CompoundLens *CompoundLensCaller) GetCompVotes(opts *bind.CallOpts, comp common.Address, account common.Address, blockNumbers []uint32) ([]CompoundLensCompVotes, error) {
	var (
		ret0 = new([]CompoundLensCompVotes)
	)
	out := ret0
...
func (_CompoundLens *CompoundLensCaller) GetGovProposals(opts *bind.CallOpts, governor common.Address, proposalIds []*big.Int) ([]CompoundLensGovProposal, error) {
	var (
		ret0 = new([]CompoundLensGovProposal)
	)
	out := ret0
...
func (_CompoundLens *CompoundLensCaller) GetGovReceipts(opts *bind.CallOpts, governor common.Address, voter common.Address, proposalIds []*big.Int) ([]CompoundLensGovReceipt, error) {
	var (
		ret0 = new([]CompoundLensGovReceipt)
	)
	out := ret0
...
//
// Solidity: function cTokenMetadata(address cToken) returns((address,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,bool,uint256,address,uint256,uint256))
...
//
// Solidity: function cTokenMetadataAll(address[] cTokens) returns((address,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,bool,uint256,address,uint256,uint256)[])
...
func (_CompoundLens *CompoundLensTransactor) GetCompBalanceMetadataExt(opts *bind.TransactOpts, comp common.Address, comptroller common.Address, account common.Address) (*types.Transaction, error) {
	return _CompoundLens.contract.Transact(opts, "getCompBalanceMetadataExt", comp, comptroller, account)
}

// GetCompBalanceMetadataExt is a paid mutator transaction binding the contract method 0x1ea63741.
//
// Solidity: function getCompBalanceMetadataExt(address comp, address comptroller, address account) returns((uint256,uint256,address,uint256))
func (_CompoundLens *CompoundLensSession) GetCompBalanceMetadataExt(comp common.Address, comptroller common.Address, account common.Address) (*types.Transaction, error) {
	return _CompoundLens.Contract.GetCompBalanceMetadataExt(&_CompoundLens.TransactOpts, comp, comptroller, account)
}

// GetCompBalanceMetadataExt is a paid mutator transaction binding the contract method 0x1ea63741.
//
// Solidity: function getCompBalanceMetadataExt(address comp, address comptroller, address account) returns((uint256,uint256,address,uint256))
func (_CompoundLens *CompoundLensTransactorSession) GetCompBalanceMetadataExt(comp common.Address, comptroller common.Address, account common.Address) (*types.Transaction, error) {
	return _CompoundLens.Contract.GetCompBalanceMetadataExt(&_CompoundLens.TransactOpts, comp, comptroller, account)
}
