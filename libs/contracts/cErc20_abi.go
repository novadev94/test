...
func (_CErc20 *CErc20Transactor) SweepToken(opts *bind.TransactOpts, token common.Address) (*types.Transaction, error) {
	return _CErc20.contract.Transact(opts, "sweepToken", token)
}

// SweepToken is a paid mutator transaction binding the contract method 0x1be19560.
//
// Solidity: function sweepToken(address token) returns()
func (_CErc20 *CErc20Session) SweepToken(token common.Address) (*types.Transaction, error) {
	return _CErc20.Contract.SweepToken(&_CErc20.TransactOpts, token)
}

// SweepToken is a paid mutator transaction binding the contract method 0x1be19560.
//
// Solidity: function sweepToken(address token) returns()
func (_CErc20 *CErc20TransactorSession) SweepToken(token common.Address) (*types.Transaction, error) {
	return _CErc20.Contract.SweepToken(&_CErc20.TransactOpts, token)
}
